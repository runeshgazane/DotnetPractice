...
// List<Product> allprod=ProductManager.GetAllProducts();
// foreach(var p in allprod){
//     Console.WriteLine(p);
// }

// Product firstprod=ProductManager.GetFirstProduct();
//     Console.WriteLine(firstprod);

//     ProductManager.Takethree();

try{
 IEnumerable<Product> allprod=ProductManager.GetSoldOutProducts();
  Console.WriteLine("All prodts"+allprod);
